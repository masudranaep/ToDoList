...
public class AddNewTask extends BottomSheetDialogFragment {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        newTaskText = getView ().findViewById ( R.id.newTasttext );
        newTaskSaveBtn = getView ().findViewById ( R.id.newTaskBtn );


        db = new DataBaseHolder ( getActivity () );
        db.openDatabase ();
        ...
        if (bundle != null) {
            ...
            if (task.length () > 0) {
                newTaskSaveBtn.setTextColor ( ContextCompat.getColor ( getContext (), R.color.black ) );
            }
